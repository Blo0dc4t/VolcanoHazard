...
- Press `O` to open the Settings overlay. It is scrollable and shows every hazard with controls to adjust:
	- selection `weight` (per-hazard multiplier that affects how likely a hazard is chosen),
